...
class ThemeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        # Mengalihkan ke halaman admin menu thames dengan success massage.
    ...
    public function show(Theme $theme)
    {
        ...
        $data = Undangan::with('couple')->firstWhere('id', '2');
    ...
    {
        # 
        $theme = Theme::with(['tags', 'category'])->firstWhere('id', $theme->id);
