            ...
            <div class="card-body">
                <div class="d-flex mb-2">
                    <div class="d-flex flex-grow-1">
                        ...
                        <select class="form-select mx-2" style="width: 4.5em" id="exampleFormControlSelect1"
                        ...
                        <tbody class="table-border-bottom-0">
                            @if ($users->count())
                                @foreach ($users as $user)
                                    <tr>
                                        <td>
                                            <img src="/{{ $user->foto }}" alt="foto-{{ $user->username }}"
                                        ...
                                        <td>
                                            <span
                                                class="badge @if ($user->isactive === '1') bg-label-success @else bg-label-danger @endif me-1">
                                                @if ($user->isactive == '1')
                                                    Aktif
                                                @else
                                                    Nonaktif
                                        ...
                                        <td>
                                            <a href="/admin/staff/{{ $user->username }}/edit" type="button" action=""
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <span class="align-self-center">Reset Password</span>
                                                ...
                                                <button type="submit" class="btn btn-sm btn-primary position-relative"
                                                    onclick="return confirm('Yakin Reset Password Staff Ini?')">
                                                    <div class="d-flex">
                                                        <span class="material-symbols-rounded me-1"
                                                    ...
                                                    @if ($user->isreqreset == 1)
                                                        <span
                                                            class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger fw-bold"
                                                            style="padding-left: 0.44rem; padding-right: 0.44rem ">
                                                            !
                                                        </span>
                                                    @endif
                                                </button>
                                            ...
                                            <form action="/admin/staff/{{ $user->username }}" method="post"
                                                ...
                                                <button type="submit"
                                                    class="btn btn-sm @if ($user->isactive == '0') btn-success @else btn-danger @endif mt-1"
                                                    onclick="return confirm('Yakin @if ($user->isactive == '0') Mengaktifkan @else Menonaktifkan @endif Staff Ini?')">
                                                    <div class="d-flex">
                                                        <span class="material-symbols-rounded me-1"
                            ...
                            @else
                                <tr>
                                    <td scope="row" colspan="7" class="text-center">Data Staff Tidak Ditemukan..
                                    </td>
                                </tr>
                            @endif
                        </tbody>
