...
<!--/ End Breadcrumb -->
    ...
    <div class="card">
        <div class="card-body">
            <form id="form-theme" action="/admin/themes/" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-9">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="category_id" class="form-select select-search @error('category_id') is-invalid @enderror">
                                @if ($categories->count())
...
<script type="text/javascript">
    ...
    function autoSlug(el) {
        ...
        oFReader.onload = function(oFREvent){
            ...
            slug.value = filename.replace('.blade.php', '');
        }
    }
</script>
@endsection