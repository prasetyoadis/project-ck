...
<div class="row"> -->
    ...
    <div class="row">
<!-- Unprogress Orders -->
        <div class="col-md-6 col-lg-4 order-0 order-lg-2 mb-4">
...
<!--/ End Unprogress Orders -->
<!-- Expense Overview -->
        <div class="col-md-6 col-lg-4 order-1 order-md-2 order-lg-0 mb-4">
            <div class="card h-100">
...
<!--/ Expense Overview -->
<!-- Order Statistics -->
        <div class="col-md-6 col-lg-4 col-xl-4 order-2 order-md-1 order-lg-0 mb-4">
            <div class="card h-100">
