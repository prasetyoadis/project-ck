<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ config('app.url') }}/admin/dashboard" class="app-brand-link">
            ...
            <span class="app-brand-text fs-3 menu-text fw-bolder ms-2">{{ config('app.name') }}</span>
        </a>
    ...
    <!-- Dashboard -->
        <li class="menu-item @if (Request::is('admin/dashboard')) active @endif">
            <a href="/admin/dashboard" class="menu-link">
                <span class="material-symbols-rounded pe-2">dashboard</span>
                <div data-i18n="Analytics">Dashboard</div>
            </a>
        </li>
    @can('super')
        <li class="menu-item @if (Request::is('admin/staff*')) active @endif">
            <a href="/admin/staff" class="menu-link">
                <span class="material-symbols-rounded pe-2">person</span>
                <div data-i18n="Analytics">Staff Admin</div>
            </a>
        </li>    
    @endcan

        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">To do</span>
        </li>

        <li class="menu-item @if (Request::is('admin/orders*')) active @endif">
            <a href="/admin/orders" class="menu-link">
                <span class="material-symbols-rounded pe-2">orders</span>
                <div data-i18n="Analytics">Orders</div>
            </a>
        </li>
        <li class="menu-item @if (Request::is('admin/invitations*')) active @endif">
        ...
        <li class="menu-item @if (Request::is('admin/category-themes*')) active @endif">
            <a href="/admin/category-themes" class="menu-link">
        ...
        <li class="menu-item @if (Request::is('admin/riwayat-orders*')) active @endif">
            <a href="/admin/riwayat-orders" class="menu-link">
                <span class="material-symbols-rounded pe-2"> history</span>
                <div data-i18n="Analytics">Riwayat Orders</div>
            </a>
        </li>
    @can('super')
        <li class="menu-item @if (Request::is('admin/riwayat-icomes*')) active @endif">
            <a href="/admin/riwayat-incomes" class="menu-link">
                <span class="material-symbols-rounded pe-2">monitoring</span>
                <div data-i18n="Analytics">Riwayat Income</div>
            </a>
        </li>
    @endcan
